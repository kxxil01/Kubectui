...
HEADER_MAX_MS="${PERF_GATE_HEADER_MAX_MS:-500}"
STATUS_MAX_MS="${PERF_GATE_STATUS_MAX_MS:-350}"
PODS_MAX_MS="${PERF_GATE_PODS_MAX_MS:-400}"
REPLICASETS_MAX_MS="${PERF_GATE_REPLICASETS_MAX_MS:-400}"
REPLICATION_CONTROLLERS_MAX_MS="${PERF_GATE_REPLICATION_CONTROLLERS_MAX_MS:-400}"
SERVICE_ACCOUNTS_MAX_MS="${PERF_GATE_SERVICE_ACCOUNTS_MAX_MS:-400}"
DEPLOYMENTS_MAX_MS="${PERF_GATE_DEPLOYMENTS_MAX_MS:-400}"
